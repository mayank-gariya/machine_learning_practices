...
The repository is logically divided into two main sections to reflect the
dual nature of my work: learning and implementation.
### 1. `/practice`
...
1. **Explore:** Understanding the math and logic in the `practice` folder.
